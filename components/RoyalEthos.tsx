...
export default function RoyalEthos() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      gsap.from(".ethos-header > *", {
        y: 30,
        opacity: 0,
        duration: 0.9,
        stagger: 0.12,
        ease: "power3.out",
        scrollTrigger: { trigger: ".ethos-header", start: "top 82%" },
      });
      ...
      gsap.from(".ethos-row", {
        ...
        stagger: 0.2,
        ease: "power3.out",
        scrollTrigger: { trigger: ".ethos-list", start: "top 80%" },
      });
    }, sectionRef);
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="ethos-list space-y-0">
          {ETHOS.map((item, i) => (
            <div key={item.num} className="ethos-row group relative">
