...
const ASSURANCES = [
  {
    ...
    icon: (
      <svg width="32" height="32" viewBox="0 0 32 32" className="fill-royal-gold">
...
export default function RoyalAssurance() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      gsap.from(".assurance-header > *", {
        y: 30,
        opacity: 0,
        duration: 1,
        stagger: 0.12,
        ease: "power3.out",
        scrollTrigger: { trigger: ".assurance-header", start: "top 82%" },
      });
      ...
      gsap.from(".assurance-card", {
        ...
        stagger: 0.18,
        ease: "power3.out",
        scrollTrigger: { trigger: ".assurance-grid", start: "top 80%" },
      });
      ...
      gsap.from(".connector-line", {
        ...
        duration: 1.5,
        ease: "power2.inOut",
        scrollTrigger: { trigger: ".assurance-grid", start: "top 75%" },
      });
    }, sectionRef);
